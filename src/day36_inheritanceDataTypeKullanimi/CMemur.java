...
public class CMemur extends BMuhasebe {
    ...
    public static void main(String[] args) {
        ...
        cunku data turu ve constructor day36_inheritanceDataTypeKullanimi.BMuhasebe
        String str="Murat";
        ArrayList<Integer> list=new ArrayList<>();
        Integer sayi=20;
        day36_inheritanceDataTypeKullanimi.BMuhasebe class'i da obje olusturulabilen bir class'dir yanidata turudur
    */
